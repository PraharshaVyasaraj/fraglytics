                ...
                <div className="p-4 flex flex-col h-full relative z-10">
                    ...
                    <div className="space-y-2 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="overflow-hidden">
                                ...
                                <div className="text-xs font-bold text-white truncate">{winner?.teamName || '-'}</div>
                            </div>
                            {winner && <div className="ml-auto text-[10px] font-mono font-bold text-cyan-400/80">{winner.totalPoints} pts</div>}
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="overflow-hidden">
                                ...
                                <div className="text-xs font-bold text-white truncate">{topFragger?.playerName || '-'}</div>
                            </div>
                            {topFragger && <div className="ml-auto text-[10px] font-mono font-bold text-violet-400/80">{topFragger.finishes} K</div>}
                        </div>
                    </div>
                    ...
                    <div className="mt-auto pt-3 border-t border-white/5 flex justify-between items-center text-[9px] font-mono text-white/40">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span>{totalKills} Elims</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <Crosshair className="w-3 h-3" />
                            <span>{(totalDamage/1000).toFixed(1)}k Dmg</span>
                        </div>
                    </div>
                </div>
            </div>
